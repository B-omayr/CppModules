...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/06 08:39:33 by iomayr            #+#    #+#             */
/*   Updated: 2022/10/07 12:28:37 by ibra             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap &ClapTrap::operator=(const ClapTrap &Input)
{
    if (this != &Input)
    {
        std::cout << "\033[1;32mClapTrap Assignement operator Called\033[0;m" << std::endl;
...
void ClapTrap::attack(const std::string &target)
{
    if (this->EnergyPoint > 0)
    {
        ...
        std::cout << "\033[1;31mClapTrap " << this->Name << \
                " Can't Attac cause he has no more EnergyPoint\033[0;m" << std::endl;
}
